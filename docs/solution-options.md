...
- Onboarding should adapt to **behavioural signals** rather than static persona labels.
...
- Templates should be framed as **examples to learn from**, not shortcuts that obscure system understanding.
...
**
Success Measurement**
Success will be evaluated using the activation metric defined in `docs/metrics.md`:
...
**Mitigation:** Emphasise learning-oriented templates and transparency (show what templates do)
